...
app.get('/todos', function(req, res) {
	...
	if (_.has(query, 'completed') && (query.completed === 'true' || query.completed === 'false')) {
	...
	// if (_.has(queryParams, 'completed') && (queryParams.completed === 'true' || queryParams.completed === 'false')) {
